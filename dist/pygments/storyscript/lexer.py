...
class StoryscriptLexer(RegexLexer):
    ...
    tokens = {
        'root' : [
            ...
            (u'(#.*)', bygroups(Comment)),
            (u'((?!\\W)(break|as|catch|returns?|continue|is|not|else|finally|if|then|try|when|while|foreach|and|or)(\\s|$))', bygroups(Keyword)),
            (u'(=)', bygroups(Operator)),
            (u'(\\()', bygroups(Punctuation), 'scope__1'),
            (u'((?!\\W)(function)(?=\\s))', bygroups(Keyword), 'function__1'),
